...
$phpMySQL         = 'PHP module mysql: <span class="' . ( ( extension_loaded( 'mysqli' ) && function_exists( 'mysqli_query' ) || extension_loaded( 'mysql' ) && function_exists( 'mysql_query' ) ) ? 'success">Installed' : 'failure">Missing' ) . '</span>';                // Core DVWA
